...
const (
	...
	defaultPodmanSocket      = "/run/user/1000/podman/podman.sock"
	traefikPodmanSocket      = "/var/run/podman/podman.sock"
)
...
func renderEnvExample(project string, ports resolvedPorts, identitySelected bool) string {
	...
	if identitySelected {
		...
		env += "PODMAN_SOCKET=" + defaultPodmanSocket + "\n"
	}
	return env
}
