...
func TestReviewLinkUsesProviderDefaultsAndCustomBases(t *testing.T) {
	if got := ReviewLink("github", config.ProviderConfig{}, "acme/api", "feature/one", "main"); !strings.Contains(got, "github.com/acme/api/compare/main...feature/one") {
		t.Fatalf("github link=%q", got)
	}
	if got := ReviewLink("github", config.ProviderConfig{APIBaseURL: "https://api.github.com/"}, "acme/api", "feature/one", "main"); !strings.Contains(got, "https://github.com/acme/api/compare/main...feature/one") {
